...
> (2026 pricing, US East); narrative is produced by the agents.
...
| Provider | Type | Monthly Storage | Monthly Egress | 3-Year TCO |
|---|---|---:|---:|---:|
| Azure NetApp Files (Std) | NetApp Managed File | $17,920.00 | $3,584.00 | $1,177,376 |
| CVO | NetApp Managed File | $10,752.00 | $3,225.60 | $765,295 |
| **FSx for NetApp ONTAP** | **NetApp Managed File** | **$8,064.00** | **$3,225.60** | **$618,123** |
| AWS S3 | Object Storage | $4,121.60 | $3,225.60 | $402,270 |
| Azure Blob | Object Storage | $3,297.28 | $3,584.00 | $376,760 |
| Google Cloud Storage | Object Storage | $3,584.00 | $2,867.20 | $353,213 |
...
ONTAP features (snapshots, SnapMirror, dedup) and NFS/SMB access. Object storage remains
a complementary FabricPool tier for the 80% cold data.
